...
<script>
const dateString = '2024-05-10T21:15:00.000Z'; // Local time without 'Z'
const date = new Date(dateString); // Appending 'Z' to indicate UTC time
...
const formattedDate = `${outdate.getUTCDate()} ${new Intl.DateTimeFormat('en-GB', { month: 'short' }).format(outdate)} ${outdate.getUTCFullYear()}`;
const formattedDate = 
console.log(formattedDate); // Output: "10 May 2024"
</script>
