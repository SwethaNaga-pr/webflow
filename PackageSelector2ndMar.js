...
var optionToSelect = document.querySelector('#Departure option[value="' + sessionStorage.getItem('SS_FromCityVar') !== null ? sessionStorage.getItem('SS_FromCityVar') : parameterValue  + '"]');
var optionToSelect2 = document.querySelector('#Arrival option[value="' + sessionStorage.getItem('SS_ToCityVar') !== null ? sessionStorage.getItem('SS_ToCityVar') : parameterValue2 + '"]');
...
document.getElementById('GuestsSummary').textContent = 'Rooms: ' + rom_val + 'Adults: ' + adutsval + ' Children: ' + chidrenval;
...
DisplayHotels(sessionStorage.getItem('SS_FromCityVar') !== null ? sessionStorage.getItem('SS_FromCityVar') : parameterValue,sessionStorage.getItem('SS_ToCityVar') !== null ? sessionStorage.getItem('SS_ToCityVar') : parameterValue2,sessionStorage.getItem('SS_Departure_date') !== null ? sessionStorage.getItem('SS_Departure_date') : formattedDate,peoplestring,total_adults+total_YC+total_AC,total_infant);
