<script src = "https://cdn.jsdelivr.net/gh/SwethaNaga-pr/webflow/PackageSelector.js"></script>
...
document.getElementById('InboundDateDisplayed'+fnights).textContent = new Date(flightOffer.route[1].local_departure).toLocaleDateString('en-GB', {day: 'numeric', month: 'short', year: 'numeric'});
