...
const promisesps = [
fetchFlightPrice(From,Destination, FDepDate, 4, adults, infants),
fetchFlightPrice(From,Destination, FDepDate, 5, adults, infants),
fetchFlightPrice(From,Destination, FDepDate, 6, adults, infants),
fetchWebflowData(Destination+'_3_'+peopledetails),
fetchWebflowData(Destination+'_4_'+peopledetails),
fetchWebflowData(Destination+'_5_'+peopledetails)
];

// Execute all promises concurrently
const resultsps = await Promise.all(promisesps);

// Now you have all the results, you can use them as needed
const [flight4n, flight5n, flight6n, star3ppn, star4ppn, star5ppn] = resultsps;
...
sessionStorage.setItem('SS_flight4n', flight4n);
sessionStorage.setItem('SS_flight5n', flight5n);
sessionStorage.setItem('SS_flight6n', flight6n);  
sessionStorage.setItem('SS_star3ppn', star3ppn);
sessionStorage.setItem('SS_star4ppn', star4ppn);
sessionStorage.setItem('SS_star5ppn', star5ppn);  
         if (Destination == 'DXB') { 
			...
			document.getElementById('DXB5Star6Nights').style.backgroundColor = '#f2f2f2';
			            document.getElementById('DXB3Star4Nights').style.color = 'white';
			document.getElementById('DXB3Star5Nights').style.color = 'black';
			document.getElementById('DXB3Star6Nights').style.color = 'black';
			document.getElementById('DXB4Star4Nights').style.color = 'black';
			document.getElementById('DXB4Star5Nights').style.color = 'black';
			document.getElementById('DXB4Star6Nights').style.color = 'black';
			document.getElementById('DXB5Star4Nights').style.color = 'black';
			document.getElementById('DXB5Star5Nights').style.color = 'black';
			document.getElementById('DXB5Star6Nights').style.color = 'black';
			...
			document.getElementById('SIN5Star6Nights').style.backgroundColor = '#f2f2f2';
						            document.getElementById('SIN3Star4Nights').style.color = 'white';
			document.getElementById('SIN3Star5Nights').style.color = 'black';
			document.getElementById('SIN3Star6Nights').style.color = 'black';
			document.getElementById('SIN4Star4Nights').style.color = 'black';
			document.getElementById('SIN4Star5Nights').style.color = 'black';
			document.getElementById('SIN4Star6Nights').style.color = 'black';
			document.getElementById('SIN5Star4Nights').style.color = 'black';
			document.getElementById('SIN5Star5Nights').style.color = 'black';
			document.getElementById('SIN5Star6Nights').style.color = 'black';
			...
			document.getElementById('HKT5Star6Nights').style.backgroundColor = '#f2f2f2';
									            document.getElementById('HKT3Star4Nights').style.color = 'white';
			document.getElementById('HKT3Star5Nights').style.color = 'black';
			document.getElementById('HKT3Star6Nights').style.color = 'black';
			document.getElementById('HKT4Star4Nights').style.color = 'black';
			document.getElementById('HKT4Star5Nights').style.color = 'black';
			document.getElementById('HKT4Star6Nights').style.color = 'black';
			document.getElementById('HKT5Star4Nights').style.color = 'black';
			document.getElementById('HKT5Star5Nights').style.color = 'black';
			document.getElementById('HKT5Star6Nights').style.color = 'black';
...
for (var i = 0; i < NightandPriceDivs.length; i++) {
    ...
    element.addEventListener('click', function(event) {
        for (var j = 0; j < NightandPriceDivs.length; j++) {
            NightandPriceDivs[j].style.backgroundColor = '#f2f2f2'; 
			NightandPriceDivs[j].style.color = 'black';
