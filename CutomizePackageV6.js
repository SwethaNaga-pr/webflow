...
console.log(parseInt(flightOffer3.price)); 
  ...
  VFlightsDivID.style.display = "none";    
	...
	sessionStorage.setItem('SS_mealplanname', selectedDiv3.querySelector('.mealplanname').textContent);
	sessionStorage.setItem('SS_mealprice', selectedDiv3.querySelector('.mealprice').textContent);
...
sessionStorage.setItem('SS_roomdesc', selectedDiv2.querySelector('.roomdesc').textContent);
sessionStorage.setItem('SS_roomsleep', selectedDiv2.querySelector('.roomsleep').textContent);
sessionStorage.setItem('SS_roombed', selectedDiv2.querySelector('.roombed').textContent);
sessionStorage.setItem('SS_roomprice', selectedDiv2.querySelector('.roomprice').textContent);
        ...
        targetDiv.style.backgroundColor = '#0474db';
		 targetDiv.style.color = 'white';
		       selectedflight = targetDiv.id;
				...
				sessionStorage.setItem('SS_outbounddepcity', selectedDiv.querySelector('.outbounddepcity').textContent);
				sessionStorage.setItem('SS_outbounddatedeptime', selectedDiv.querySelector('.outbounddatedeptime').textContent);
				sessionStorage.setItem('SS_flighttext', selectedDiv.querySelector('.flighttext').textContent);
				sessionStorage.setItem('SS_flightdurationclass', selectedDiv.querySelector('.flightdurationclass').textContent);
				sessionStorage.setItem('SS_outboundflightid', selectedDiv.querySelector('.outboundflightid').textContent);
				sessionStorage.setItem('SS_carriernameclass', selectedDiv.querySelector('.carriernameclass').textContent);
				sessionStorage.setItem('SS_outboundarrcity', selectedDiv.querySelector('.outboundarrcity').textContent);
				sessionStorage.setItem('SS_outbounddatearrtime', selectedDiv.querySelector('.outbounddatearrtime').textContent);
				sessionStorage.setItem('SS_inbounddepcity', selectedDiv.querySelector('.inbounddepcity').textContent);
				sessionStorage.setItem('SS_inbounddatedeptime', selectedDiv.querySelector('.inbounddatedeptime').textContent);
				sessionStorage.setItem('SS_flightdurationclass2', selectedDiv.querySelector('.flightdurationclass2').textContent);
				sessionStorage.setItem('SS_carriernameclass2', selectedDiv.querySelector('.carriernameclass2').textContent);
				sessionStorage.setItem('SS_inboundflightid', selectedDiv.querySelector('.inboundflightid').textContent);
				sessionStorage.setItem('SS_flighttext2', selectedDiv.querySelector('.flighttext2').textContent);
				sessionStorage.setItem('SS_inbounddatearrtime', selectedDiv.querySelector('.inbounddatearrtime').textContent);
				sessionStorage.setItem('SS_inboundarrcity', selectedDiv.querySelector('.inboundarrcity').textContent);
				sessionStorage.setItem('SS_flightprice', selectedDiv.querySelector('.flightprice').textContent);
